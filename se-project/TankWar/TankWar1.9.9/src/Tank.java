...
public class Tank {
	...
	public Direction barrelDir = Direction.D;
	private int id;
	...
	void locateDirection () {
		...
		if (dir != oldDir) {
			this.tankClient.nc.send(new TankMoveMsg(id,x,y,dir,barrelDir));
		}
	}
	...
	private void fire () {
		...
		Missile m = new Missile (id,x,y,barrelDir,robotic,tankClient);
		MissileNewMsg msg = new MissileNewMsg(m);
		this.tankClient.nc.send(msg);
